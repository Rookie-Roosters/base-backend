...
import { ValidateOptionalNumberPipe } from 'src/utils/pipes/validate-optional-number.pipe';
...
export class ChatsController {
  ...
  @ApiQuery({ name: 'page', type: Number, description: '`min`: 0, `default`: 0', required: false })
